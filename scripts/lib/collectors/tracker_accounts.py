...
def fetch(config_dir: Path) -> dict:
    ...
    if bt_key:
        if bt_user:
            ...
            accounts["blutopia.cc"] = {"error": "Username required — add your Blutopia username in Settings → Services"}
    ...
    if bhd_key:
        if bhd_user:
            ...
            accounts["beyond-hd.me"] = {"error": "Username required — add your Beyond-HD username in Settings → Services"}
